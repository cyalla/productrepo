...
public ProductDTO createProduct(@RequestBody ProductDTO productDTO) {
    ...
    if (priceDouble < 0 || priceDouble > 1000) {
        throw new IllegalArgumentException("Price out of valid range (0 to 1000)");
    }
    ...
    if (taxDouble < 0 || taxDouble > 100) {
        throw new IllegalArgumentException("Tax rate out of valid range (0 to 100)");
    }
