...
public ProductDTO createProduct(@RequestBody ProductDTO productDTO) {
    ...
    if (productDTO.getName() == null || productDTO.getName().trim().isEmpty()) {
        throw new IllegalArgumentException("Name in ProductDTO is empty");
    }
    if (productDTO.getPrice() == null || productDTO.getPrice().trim().isEmpty()) {
        throw new IllegalArgumentException("Price in ProductDTO is empty");
    }
    if (productDTO.getTax() == null || productDTO.getTax().trim().isEmpty()) {
        throw new IllegalArgumentException("Tax in ProductDTO is empty");
    }
    ...
    if (savedProduct == null) {
        throw new IllegalArgumentException("Saved product is null");
    }
