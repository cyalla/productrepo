...
public ProductDTO createProduct(@RequestBody ProductDTO productDTO) {
    try {
        if (productDTO == null || productDTO.getName() == null || productDTO.getPrice() == null || productDTO.getTax() == null) {
            throw new IllegalArgumentException("Invalid productDTO provided");
        }
        ...
        return new ErrorDTO("Invalid input provided");
    } catch (Exception e) {
        logger.error("An error occurred while creating the product: ", e);
        return new ErrorDTO("An error occurred while creating the product");
    }
}
    @GetMapping("/{id}")
