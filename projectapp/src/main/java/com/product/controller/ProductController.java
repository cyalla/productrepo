...
public ProductDTO createProduct(@RequestBody ProductDTO productDTO) {
    try {
        ...
        logger.log(Level.ERROR, "Illegal argument: " + e.getMessage(), e);
        throw new GlobalExceptionHandler.IllegalArgumentException("Invalid argument", e);
    } catch (Exception e) {
        logger.log(Level.ERROR, "Error creating product: " + e.getMessage(), e);
        throw new GlobalExceptionHandler.RuntimeException("Error creating product", e);
    }
}
    @GetMapping("/{id}")
